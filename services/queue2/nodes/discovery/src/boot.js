...
export default createHookApp({
    ...
    features: [
        ...
        ['$FETCHQ_INIT', ({ registerWorker }, ctx) => {
            registerWorker([
                workers.directoryWorker(ctx),
                workers.cityWorker(ctx),
                workers.countryWorker(ctx),
                // workers.locationWorker(ctx),
                workers.locationPostWorker(ctx),
                workers.profilePostWorker(ctx),
                workers.profilePostWorker(ctx),
                workers.profilePostWorker(ctx),
                workers.profilePostWorker(ctx),
                workers.profilePostWorker(ctx),
